...
module.exports.run = async (bot, message, args) => {
 ...
 if (!message.member.hasPermission(Rol => Rol.name === 'Mute Atma Yetkisi'))  return message.channel.send('Bu komutu kullanmak için **Düzenleyin** yetkisine sahip olmalısın!') 
